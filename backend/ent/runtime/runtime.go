...
func init() {
	...
	// groupDescShieldEnabled is the schema descriptor for shield_enabled field.
	groupDescShieldEnabled := groupFields[4].Descriptor()
	// group.DefaultShieldEnabled holds the default value on creation for the shield_enabled field.
	group.DefaultShieldEnabled = groupDescShieldEnabled.Default.(bool)
